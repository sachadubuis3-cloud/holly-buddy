...
function App() {
  ...
  const submit = async (event: React.FormEvent) => {
    ...
    if (mode === 'signup') {
      ...
      if (error) setMessage(error.message);
      else { setMessage('Mot de passe mis à jour. Tu peux continuer.'); setMode('login'); setNewPassword(''); }
    }
    setBusy(false);
  };
